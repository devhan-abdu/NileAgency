import { Layout, Code, Smartphone, Megaphone, PenTool, ShoppingCart, Search, Brush, CheckCircle } from 'lucide-react';
...
export const benefits = [
  { title: 'Tailored Solutions', description: 'Custom strategies to meet your unique goals.', image: '/solution2.jpg' },
  { title: 'Innovative Technology', description: 'Using the latest tools for maximum impact.', image: '/tech.png' },
  { title: 'Proven Results', description: '43% average increase in client conversions.', image: '/successprove.png' },
  { title: 'End-to-End Support', description: 'From concept to launch, we’ve got you.', image: '/endtoend.jpg' },
];
